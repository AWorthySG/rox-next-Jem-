...
export const JOB_NAME: Record<JobId, string> = {
  ...
  [JobId.Chronomancer]: "Chronomancer",
  [JobId.DragonFist]: "Dragon Fist",
  [JobId.PhantomDancer]: "Phantom Dancer",
  [JobId.Maestro]: "Maestro",
  [JobId.Begetter]: "Begetter",
};
...
export const JOB_TREE: Record<JobId, JobId[]> = {
  ...
  [JobId.Professor]: [JobId.Chronomancer],
  [JobId.Monk]: [JobId.Champion],
  [JobId.Champion]: [JobId.DragonFist],
  [JobId.Rogue]: [JobId.Stalker],
  [JobId.Stalker]: [JobId.PhantomDancer],
  [JobId.Bard]: [JobId.Minstrel],
  [JobId.Minstrel]: [JobId.Maestro],
  [JobId.Alchemist]: [JobId.Creator],
  [JobId.Creator]: [JobId.Begetter],
  [JobId.Chronomancer]: [],
  [JobId.DragonFist]: [],
  [JobId.PhantomDancer]: [],
  [JobId.Maestro]: [],
