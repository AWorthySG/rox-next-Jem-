...
export interface SelfState {
  ...
  pass: { level: number; exp: number; expToNext: number; premium: boolean; claimedFree: number[]; claimedPremium: number[] };
  album: { registered: string[]; total: number }; // Card Album collection index
  mountId: string | null;
