...
const DEFS: Record<string, AppearanceDef> = {
  ...
  // Amatsu
  poison_spore: { inner: "#5aff30", outer: "#1a2014", eye: "#aaff40", scale: 1.1 },
  karakasa: { inner: "#c8b890", outer: "#1a1c24", eye: "#ff2a2a", scale: 1.3 },
  tengu: { inner: "#d83a2a", outer: "#1c1a1c", eye: "#ffd24a", scale: 1.45 },
  ...
  the_merlion: { inner: "#e03020", outer: "#7a7e88", eye: "#ff3a1a", scale: 3.0, boss: true },
  ...
  sentosa_merlion: { inner: "#9ab0a8", outer: "#3a4a44", eye: "#cfeede", scale: 3.3, boss: true },
  leviathan: { inner: "#60a0c0", outer: "#0a3a5a", scale: 3.4, boss: true },
  // Kampong Glam (Singapore)
  bugis_corsair: { inner: "#f0e0a0", outer: "#2a2a30", eye: "#ffd24a", scale: 1.3 },
  djinn: { inner: "#ffd040", outer: "#c83810", eye: "#fff0a0", scale: 1.35 },
  batik_serpent: { inner: "#f0b040", outer: "#1a2240", eye: "#ff5020", scale: 1.4 },
  ...
  skyline_colossus: { inner: "#ff9020", outer: "#1a1a1e", eye: "#ffd040", scale: 3.3, boss: true },
  spectra_dragon: { inner: "#eafaff", outer: "#aab8c8", eye: "#dffaff", scale: 3.2, boss: true },
  // Jurong (Singapore)
  ...
  war_ghost: { inner: "#cfe8ff", outer: "#5a7a96", eye: "#eaffff", scale: 1.3 },
  bunker_sentry: { inner: "#4a5260", outer: "#cfc8bc", eye: "#ff8a20", scale: 1.4 },
  colonial_wraith: { inner: "#d0d0d8", outer: "#5a5a6a", scale: 2.7, boss: true },
  hill_sentinel: { inner: "#ff7a20", outer: "#5a5a58", eye: "#ffaa30", scale: 3.0, boss: true },
  // Mount Faber (Singapore)
  cable_wraith: { inner: "#2ad0b0", outer: "#0a0e14", eye: "#7affe0", scale: 1.3 },
  peak_eagle: { inner: "#f4f0e6", outer: "#c8b89a", eye: "#ffc030", scale: 1.3 },
  stone_golem: { inner: "#ff6a1a", outer: "#7a766e", eye: "#ff9020", scale: 1.4 },
  ...
  ion_colossus: { inner: "#40a0ff", outer: "#10182a", eye: "#aef0ff", scale: 3.3, boss: true },
  orchard_specter: { inner: "#40d0e0", outer: "#3a4048", eye: "#ffd060", scale: 3.3, boss: true },
  ...
  temple_tortoise: { inner: "#c8a040", outer: "#3a3a2a", eye: "#ffc040", scale: 1.5 },
  shrine_carp: { inner: "#eafaff", outer: "#8aa0b8", eye: "#cfeeff", scale: 1.3 },
  pilgrim_wisp: { inner: "#ffd070", outer: "#c87020", eye: "#fff0c0", scale: 1.3 },
  ...
  reef_lobster: { inner: "#e07020", outer: "#1a3a6a", eye: "#ff9030", scale: 1.3 },
  cliff_bat: { inner: "#6a5a6a", outer: "#2a2a3a", eye: "#eafaff", scale: 1.2 },
  coastal_gun_golem: { inner: "#8a8a7a", outer: "#3a3a2a", scale: 2.8, boss: true },
  dragon_teeth_wraith: { inner: "#c0d0e0", outer: "#0a0e16", eye: "#eafaff", scale: 2.8, boss: true },
  ...
  kelong_crab: { inner: "#e07020", outer: "#14161c", eye: "#ff9030", scale: 1.3 },
  lalang_sprite: { inner: "#fff4d0", outer: "#9a9080", eye: "#fffae0", scale: 1.2 },
  waterway_egret: { inner: "#eafaff", outer: "#aab8d0", eye: "#ffc040", scale: 1.4 },
  ...
  barrage_leviathan: { inner: "#2aa0c0", outer: "#0a2030", eye: "#7af0ff", scale: 3.4, boss: true },
  tempest_dragon: { inner: "#a0c0e0", outer: "#1a3a6a", scale: 3.4, boss: true },
  lion_city_colossus: { inner: "#c8a040", outer: "#4a4e54", eye: "#ffd24a", scale: 4.6, boss: true },
  tide_emperor: { inner: "#30c0c8", outer: "#0a2228", eye: "#8af0f0", scale: 4.6, boss: true },
  ridge_drongo: { inner: "#7af0ff", outer: "#1a3a44", eye: "#cffaff", scale: 1.2 },
  fern_sprite: { inner: "#fff0b0", outer: "#3a6a2a", eye: "#fffae0", scale: 1.2 },
